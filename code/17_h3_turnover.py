...
turnovers = pd.read_csv('data/processed/turnover_events.csv',
                        dtype={'gvkey': str})
universe = pd.read_csv('data/processed/sample_firms.csv',
...
xs.to_csv('data/processed/turnover_cross_section.csv', index=False)
...
with open('output/h3_regression_results.txt', 'w', encoding='utf-8') as f:
