...
# ============================================================
final = pd.read_csv('data/processed_extended/ceo_speech_final.csv',
                    dtype={'gvkey': str})
print(f"\nTranscripts to score: {len(final)}")

speech_dir = Path('data/processed_extended/ceo_speech')
...
call_scores.to_csv('data/processed_extended/call_scores.csv', index=False)
...
# ============================================================
fy.to_csv('data/processed_extended/overconfidence_index.csv', index=False)
...
plt.tight_layout()
plt.savefig('output/extended/components_histograms.png', dpi=120)
plt.close()
...
plt.savefig('output/extended/overconfidence_distribution.png', dpi=120)
plt.close()

print("\nSaved:")
print("  data/processed_extended/call_scores.csv             <- quarterly raw scores")
print("  data/processed_extended/overconfidence_index.csv    <- final firm-year index")
print("  output/extended/components_histograms.png")
print("  output/extended/overconfidence_distribution.png")