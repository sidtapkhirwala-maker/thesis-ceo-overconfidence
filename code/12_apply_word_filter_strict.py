...
# Load the manifest
# ============================================================
manifest = pd.read_csv('data/processed_strict/ceo_speech_manifest.csv',
                      dtype={'gvkey': str})
...
# Save outputs
# ============================================================
final_calls.to_csv('data/processed_strict/ceo_speech_final.csv', index=False)
fy_keep.to_csv('data/processed_strict/final_firm_years.csv', index=False)
fy_drop.to_csv('data/processed_strict/dropped_firm_years.csv', index=False)

print("\nSaved:")
print("  data/processed_strict/ceo_speech_final.csv     <- use this for index construction")
print("  data/processed_strict/final_firm_years.csv     <- use this to filter Compustat panel")
print("  data/processed_strict/dropped_firm_years.csv   <- for the limitations section")