...
bridge_primary[['gvkey', 'companyid', 'companyname']].to_csv(
    'data/processed_extended/gvkey_companyid_bridge.csv', index=False
)
...
transcripts = safe_sql(f"""
    ...
    WHERE d.companyid IN {companyids}
      ...
      AND d.mostimportantdateutc BETWEEN '2018-01-01' AND '2024-12-31'
""")
...
canonical = canonical[
    canonical['call_year'].between(2017, 2024)
...
# 6) Save outputs
# ============================================================
canonical.to_csv('data/processed_extended/transcript_inventory.csv', index=False)
coverage.to_csv('data/processed_extended/transcript_coverage.csv', index=False)
print("\nSaved:")
print("  data/processed_extended/gvkey_companyid_bridge.csv")
print("  data/processed_extended/transcript_inventory.csv")
print("  data/processed_extended/transcript_coverage.csv")
