...
# ============================================================
fy_keep = pd.read_csv('data/processed/final_firm_years.csv',
                      dtype={'gvkey': str})
...
# ============================================================
funda = pd.read_csv('data/processed/compustat_panel.csv',
                    dtype={'gvkey': str})
...
# ============================================================
funda_panel = funda[funda['fyear'].between(2017, 2023)].copy()
...
# ============================================================
panel.to_csv('data/processed/regression_panel.csv', index=False)
print(f"\nSaved: data/processed/regression_panel.csv")
