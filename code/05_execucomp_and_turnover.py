...
turnovers = anncomp_dedup[
    ...
    & (anncomp_dedup['year'].between(2018, 2022))
].copy()
...
# Save outputs
# ============================================================
anncomp_dedup.to_csv('data/processed/execucomp_ceo_panel.csv', index=False)
turnovers.to_csv('data/processed/turnover_events.csv', index=False)
print("\nSaved:")
print("  data/processed/execucomp_ceo_panel.csv")
print("  data/processed/turnover_events.csv")
