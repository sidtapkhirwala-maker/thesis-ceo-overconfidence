...
# ============================================================
final = pd.read_csv('data/processed_strict/ceo_speech_final.csv',
                    dtype={'gvkey': str})
print(f"\nTranscripts to score: {len(final)}")

speech_dir = Path('data/processed_strict/ceo_speech')
...
call_scores.to_csv('data/processed_strict/call_scores.csv', index=False)
...
# ============================================================
fy.to_csv('data/processed_strict/overconfidence_index.csv', index=False)
...
plt.tight_layout()
plt.savefig('output/strict/components_histograms.png', dpi=120)
plt.close()
...
plt.savefig('output/strict/overconfidence_distribution.png', dpi=120)
plt.close()

print("\nSaved:")
print("  data/processed_strict/call_scores.csv             <- quarterly raw scores")
print("  data/processed_strict/overconfidence_index.csv    <- final firm-year index")
print("  output/strict/components_histograms.png")
print("  output/strict/overconfidence_distribution.png")