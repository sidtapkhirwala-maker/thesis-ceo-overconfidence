...
# Load inputs
# ============================================================
inventory = pd.read_csv('data/processed_strict/transcript_inventory.csv',
                        dtype={'gvkey': str})
...
os.makedirs('data/processed_strict/ceo_speech', exist_ok=True)
...
for i, row in inventory.iterrows():
    ...
    fpath = f"data/processed_strict/ceo_speech/{fname}"
...
# ============================================================
pd.DataFrame(manifest).to_csv('data/processed_strict/ceo_speech_manifest.csv', index=False)
pd.DataFrame(unmatched).to_csv('data/processed_strict/ceo_speech_unmatched.csv', index=False)

print("\nSaved:")
print("  data/processed_strict/ceo_speech_manifest.csv")
print("  data/processed_strict/ceo_speech_unmatched.csv")
print(f"  data/processed_strict/ceo_speech/  ({len(manifest)} text files)")
