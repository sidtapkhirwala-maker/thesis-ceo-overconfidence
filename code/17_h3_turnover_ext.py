...
turnovers = pd.read_csv('data/processed_extended/turnover_events.csv',
                        dtype={'gvkey': str})
universe = pd.read_csv('data/processed_extended/sample_firms.csv',
...
xs.to_csv('data/processed_extended/turnover_cross_section.csv', index=False)
...
with open('output/extended/h3_regression_results.txt', 'w', encoding='utf-8') as f:
...
print("\nSaved: output/extended/h3_regression_results.txt")