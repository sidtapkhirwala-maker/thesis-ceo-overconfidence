...
# ============================================================
fy_keep = pd.read_csv('data/processed_extended/final_firm_years.csv',
                      dtype={'gvkey': str})
...
# ============================================================
funda = pd.read_csv('data/processed_extended/compustat_panel.csv',
                    dtype={'gvkey': str})
...
# ============================================================
panel.to_csv('data/processed_extended/regression_panel.csv', index=False)
print(f"\nSaved: data/processed_extended/regression_panel.csv")
