...
# Load inputs
# ============================================================
inventory = pd.read_csv('data/processed/transcript_inventory.csv',
                        dtype={'gvkey': str})
...
# ============================================================
pd.DataFrame(manifest).to_csv('data/processed/ceo_speech_manifest.csv', index=False)
pd.DataFrame(unmatched).to_csv('data/processed/ceo_speech_unmatched.csv', index=False)

print("\nSaved:")
print("  data/processed/ceo_speech_manifest.csv")
print("  data/processed/ceo_speech_unmatched.csv")
print(f"  data/processed/ceo_speech/  ({len(manifest)} text files)")
